...
M_GLOBALS_DEP = $(APP_PATH)$(PATHSEP)m_globals.h
...
PROJECT_DEP = $(APP_PATH)$(PATHSEP)app_defs.h \
	...
	$(APP_PATH)$(PATHSEP)m_crypto.h \
	$(APP_PATH)$(PATHSEP)m_dbase.h \
	...
	$(APP_PATH)$(PATHSEP)$(PROJECT).h \
	$(APP_PATH)$(PATHSEP)wx_incs.h \
	$(APP_PATH)$(PATHSEP)x_panel.h \
	$(APP_PATH)$(PATHSEP)y_panel.h \
	...
	$(APP_PATH)$(PATHSEP)m_crypto.cpp \
	$(APP_PATH)$(PATHSEP)m_dbase.cpp \
	...
	$(APP_PATH)$(PATHSEP)x_panel.cpp \
	$(APP_PATH)$(PATHSEP)y_panel.cpp
...
as2print$(OBJ_EXT):	$(APP_PATH)$(PATHSEP)as2print.cpp $(AS2PRINT_DEP)
	$(CPP) $(COMPILE_ONLY) $(COMPILE_FLAGS) $(APP_PATH)$(PATHSEP)as2print.cpp
...
DATAREEL_OBJECTS = $(DATAREEL_DATABASE_CORE_OBJECTS) \
